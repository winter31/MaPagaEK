    ...
    <div id="header">
				...
				<div class="top">
					...
					<!-- Nav -->
						<nav id="nav">
							<ul>
							<li><a href="${pageContext.request.contextPath }/" id="top-link" class="skel-layers-ignoreHref"><span class="icon fa-home" style="font-size: 18px;"> <!-- onclick=$("#menu-close").click(); --> Home</span></a></li>
